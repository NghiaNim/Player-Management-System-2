...
public class XRSceneTransitionManager : MonoBehaviour
{
    ...
    public static void ConfigureNewXRScene(Scene xrScene, Scene newScene)
    {
        ...
        GameObject sceneControllerObject = newSceneObjects.First((obj) => { return obj.CompareTag("XRSceneController"); });

        XRSceneController sceneController = sceneControllerObject.GetComponent<XRSceneController>();
